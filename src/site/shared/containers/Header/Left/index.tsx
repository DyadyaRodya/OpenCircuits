...
export const HeaderLeft = ({ closeModal, helpers }: Props) => {
    ...
    return (
        <div className="header__left">
            ...
            <button type="button" title="History"
                ...
                <img src="/moodle-develop/question/type/digitalcircuit/img/icons/history-light.svg" alt="History box icon (light)"></img>
            </button>

            <button type="button" title="Lock/Unlock Editing"
                    className="header__left__lock"
                    onClick={() => dispatch(ToggleCircuitLocked())}>
                <img src="/moodle-develop/question/type/digitalcircuit/img/icons/lock_open.svg" className={isLocked ? "hide" : ""}
                     width="18px" height="18px" alt="Icon for unlocked lock" />
                <img src="/moodle-develop/question/type/digitalcircuit/img/icons/lock.svg"      className={isLocked ? "" : "hide"}
                     width="18px" height="18px" alt="Icon for lock" />
            </button>

            <Button color={"success"} onClick={() => closeModal()}>Close editor</Button>
            ...
            {/* <button type="button" title="Duplicate the circuit"
                ...
                <img src="/moodle-develop/question/type/digitalcircuit/img/icons/content_copy.svg" height="100%" alt="Copy circuit" />
            </button> */}

            <img src="/moodle-develop/question/type/digitalcircuit/img/icons/error.svg" className={error ? "" : "hide"}
