...
export const HeaderRight = ({ helpers, /* info, extraUtilities */ }: Props) => {
    ...
    return (<div className="header__right" id="header__right"> 
        <div className="header__right__wrapper">
            {/* <button type="button" onClick={() => setHidden(!isHidden)}>
                <img className="expand" src={isHidden ? "/moodle-develop/question/type/digitalcircuit/img/icons/expand.svg" : "/moodle-develop/question/type/digitalcircuit/img/icons/collapse.svg"}
